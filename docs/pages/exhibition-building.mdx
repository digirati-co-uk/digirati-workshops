...
In the multi-image slide example below, you can create ‘Tour steps’ which guide users through your exhibition, by explicitly adding additional navigation through your content. each of the images on the canvas have been added as a 'Tour step' so that users can be directed to each image as part of the exhibition. We'll discuss how these work, and how they can be used for other types of annotations.
