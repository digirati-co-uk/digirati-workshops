...
We have gathered some examples to help inspire, see [Examples of IIIF to explore](/docs/pages/examples-of-iiif-to-explore.mdx)
...
A standalone viewer developed by TU Delft and Digirati, to enable...
