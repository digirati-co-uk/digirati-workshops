...
After selecting to open an existing manifest (see Getting started), or creating a new manifest, the Manifest Editor opens in the default overview:
...
Clicking on the ‘Canvases’ icon in the left hand panel, navigates you to the Canvas view, presenting the list of available canvases in the left hand panel, the selected canvas in the central view with the right hand panel opening the detailed metadata for the first Canvas.
